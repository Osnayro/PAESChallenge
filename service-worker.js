...
/**
 * ============================================================
 * PAES Challenge — Service Worker v5.3.0
 * Cache y funcionalidad offline para PWA
 * ============================================================
 */

const CACHE_NAME = 'paes-challenge-v5.3.0';
...
    console.log('🦉 PAES Challenge v5.3.0 - Instalando...');
    event.waitUntil(
...
    console.log('🦉 PAES Challenge v5.3.0 - Activando...');
    event.waitUntil(
        caches.keys()
            .then((keys) => {
                return Promise.all(
...
console.log('🦉 PAES Challenge Service Worker v5.3.0 registrado');
